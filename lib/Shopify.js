...
export async function getCollection(handle) {
  ...
  const response = await ShopifyData(query);
  const singleCollection = response.data.collectionByHandle ? response.data.collectionByHandle : [];
...
export async function getProductsInCollections(handle) {
  ...
  const response = await ShopifyData(query);
  const allProducts = response.data.collectionByHandle ? response.data.collectionByHandle : [];
