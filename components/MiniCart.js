...
export default function MiniCart({ cart }) {
  ...
  return (
    <motion.div
      animate={{ opacity: 1 }}
      initial={{ opacity: 0 }}
      className="fixed right-0 top-0 flex h-full w-full justify-end bg-black/[0.7]"
      onClose={() => {
    ...
    >
      <motion.div
        ...
        className="relative w-1/4 overflow-scroll bg-white p-8"
      >
        <div className="absolute right-5 top-5 ml-3 flex h-7 items-center">
          <button
            ref={cancelButtonRef}
            type="button"
